# The Bloggity Project (WIP)
The project aims to deliver an easy way to build, customize and host your own, independent blog — both in the infrastructure and freedom of speech sense.

## The philosophy

The Internet is clearly a centralized thing now. Even though nowadays everyone is a creator in some way, the flow and distribiution of information are managed by big, self-interest oriented platforms. 

The Bloggity Project tries to solve that problem, allowing everybody to contribute for the decentralization of information and self-manage information they post on the Internet. Bloggity tries to become the most **accessible**, **free** and **powerful** tool to do this.
